...
//	}
	...
	public static StrategyGeneration generateMutation(StrategyGeneration parents, int numChildren, double mutationRate) {
		ArrayList<LearningStrategy> childrenStrategies = new ArrayList<LearningStrategy>();
		
		for(int i = 0; i < numChildren; i++)
		{
			LearningStrategy child = parents.getRandomStrategy().getMutatedChild(mutationRate);
